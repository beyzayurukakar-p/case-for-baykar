// Generated using React Native Paper's tool
...
export const customColors = {
  light: {
    ...
    backgroundTransparent: 'rgba(255, 251, 255, 0)',
    onBackground: 'rgb(27, 27, 31)',
    surface: 'rgb(255, 251, 255)',
    onSurface: 'rgb(27, 27, 31)',
    disabledOnSurface: 'rgb(118, 118, 128)',
    surfaceVariant: 'rgb(227, 225, 236)',
    surfaceVariant2: 'rgb(240, 238, 249)',
    onSurfaceVariant: 'rgb(70, 70, 79)',
    outline: 'rgb(118, 118, 128)',
    outlineVariant: 'rgb(199, 197, 208)',
    outlineVariant2: 'rgb(179, 177, 188)',
    shadow: 'rgb(0, 0, 0)',
    scrim: 'rgb(0, 0, 0)',
